...
import { ActivityCardData } from '../../types/onboarding';
...
export const ActivityCard = ({ data, isSelected, onClick }: ActivityCardProps) => {
      ...
      <div className="relative z-10 py-3 px-4">
        <div className="flex flex-col items-center gap-1.5">
          ...
          <div className="flex items-center gap-2 w-full">
            ...
            />
            <h3 className="text-[16px] font-semibold text-foreground text-center flex-1">
              {data.title}
            </h3>
          </div>
          ...
          {/* Подзаголовок */}
          <p 
            className="text-[15px] text-foreground text-center line-clamp-3 whitespace-pre-line"
            style={{ opacity: 0.85 }}
          >
            {data.subtitle}
          </p>
